 ...
 */
public class ToReadBooksFragment extends Fragment {
    ...
    public void updateUI(){
        books = database.getToReadBooks(userAccount.getId());
    ...
    public static ToReadBooksFragment newInstance(GoogleSignInAccount account){
        ToReadBooksFragment f = new ToReadBooksFragment();
